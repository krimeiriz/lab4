...
namespace labWork3Tests.Core
{
        ...
        where T : ContactRepository
    {
        ...
        [Fact]
        public async void AddContact_Add1Contact()
        {
        ...
        [Fact]
        public async void GetAllContacts_Get2Contacts()
        {
            var contact1 = new Contact{FirstName = "test", LastName = "test", PhoneNumber = "777", Email = "test"};
            await contactRepository.AddContact(contact1);
            ...
            )
        {
            foreach (string name in names)
            {
                ...
                await contactRepository.AddContact(c);
            }
        ...
        public async void FindByWholeFields(
